      ...
      <div className="container mx-auto px-4">
        <div className="mb-10 flex flex-col gap-6 md:mb-14 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl space-y-3">
            <div className="text-xs font-semibold uppercase tracking-[0.28em] text-stone-500 dark:text-stone-400">Featured selection</div>
            <h2 className="text-3xl font-semibold tracking-[-0.04em] text-slate-900 dark:text-white sm:text-4xl">
              Popular tools, presented with less noise.
            </h2>
            <p className="text-base leading-7 text-stone-600 dark:text-slate-300">
              A small edit of high-demand products from across the marketplace, surfaced for speed and clarity.
            </p>
          </div>
